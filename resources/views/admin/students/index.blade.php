<x-layouts.admin>
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.students.create') }}" class="btn btn-blue text-xs">
            Nuevo
        </a>
      </div>  
            ...
            @foreach ($students as $student)
                ...
                <td class="px-6 py-4">
                   <div class="flex items-center space-x-2">
                     <a href="{{ route('admin.students.edit',$student) }}" class="text-xs btn btn-green">Editar</a>
                    <form class="delete-form" action="{{ route('admin.students.destroy',$student) }}" method="POST">
                        @csrf
                        @method('DELETE')
